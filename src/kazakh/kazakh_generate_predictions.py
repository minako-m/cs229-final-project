...
from kazakh_train import CRNN, KazakhOCRDataset, ctc_greedy_decode, CONFIG, KAZAKH_VOCAB

MODEL_PATH = 'kazakh_best_crnn.pt'
...
dataset = KazakhOCRDataset(IMAGE_DIR, ANNOTATION_DIR, vocab=KAZAKH_VOCAB, img_height=IMG_HEIGHT)
...
# save
output_path = 'kazakh_predictions.json'
