...
def main(json_path):
    ...
    plt.title('Top 10 Most Accurate Characters', y=0.98)
    plt.tight_layout()
    # Save the plot
    ...
    save_path = os.path.join(save_dir, "top10_accurate_characters_kazakh.png")
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python accuracy_per_character.py <path_to_json>")
        sys.exit(1)
    main(sys.argv[1])
